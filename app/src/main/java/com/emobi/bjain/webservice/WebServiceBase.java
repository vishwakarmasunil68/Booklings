package com.emobi.bjain.webservice;
...
public class WebServiceBase extends AsyncTask<String,Void,String> {
    ...
    public WebServiceBase(ArrayList<NameValuePair> nameValuePairs, Activity activity, String msg,View view,boolean is_buyed){
        this.nameValuePairs=nameValuePairs;
        this.activity=activity;
        this.msg=msg;
        this.view=view;
